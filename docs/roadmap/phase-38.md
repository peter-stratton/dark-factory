...
**Milestone**: `Phase 38: Security-Aware Review & Prompt Auditability` | **Label**: `phase-38`
...
**Planning doc**: `docs/planning/phase-38-security-aware-review-and-prompt-auditability.md`
